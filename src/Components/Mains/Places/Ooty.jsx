...
const loadMore=()=>{
    ...
    const slice = Ooty1.slice(0,noOfeElement);
...
<div className='pls1'>
      <a className='pls2' href='/tplaces'  id='pls1'>All</a>
       <a className='pls2a pls21' href='/ooty'  id='pls2'>Ooty</a>
...
<div className='mpls1'>
    ...
    <div className='mpls3'><a className='mpls2 ' href='/tplaces'  id='pls1'>All</a>
       <a className='mpls2a mpls21' href='/ooty'  id='pls2'>Ooty</a>
...
<div className='tpls5'>
    <div  className='tpls51'>Ooty - The Queen of Hill Stations</div>
    <div  className='tpls52'>Ooty is a picture-perfect blend of misty mountains, colonial charm, and endless greenery. From the <br></br>shimmering Ooty Lake to the panoramic Doddabetta Peak, every corner feels like a postcard. Don't<br></br> miss the Nilgiri Mountain Railway—a nostalgic journey through tunnels, forests, and breathtaking tea<br></br> plantations.</div>
