...
const slice = Masinagudi1.slice(0,noOfeElement);
...
<div className='pls1'>
  <a className='pls2' href='/tplaces'  id='pls1'>All</a>
   ...
   <a className='pls2a pls21' href='/masinagudi' id='pls8' >Masinagudi</a>
...
<div className='mpls3'><a className='mpls2 ' href='/tplaces'  id='pls1'>All</a>
  ...
  <div className='mpls6'><a className='mpls2a mpls21' href='/masinagudi' id='pls8' >Masinagudi</a>
...
<div className='tpls5'>
    <div  className='tpls51'>Masinagudi - The Untamed <br></br> Frontier</div>
