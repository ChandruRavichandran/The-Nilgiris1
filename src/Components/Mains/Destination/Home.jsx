...
const Home = () => {
  ...
  const allPages = Object.entries(pagesData); // Convert object to array for iteration
  ...
  return (
    <>
      <div className='abu1'>
        ...
        <div className='des11'>
          {/* Navigation Tabs */}
          <div className='pls1'>
            <a className='pls2a' href='/tplaces' id='pls1'>All Places</a>
   ...
   <div className='mpls3'><a className='mpls2a ' href='/tplaces'  id='pls1'>All Places</a>
