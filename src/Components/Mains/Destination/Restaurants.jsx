...
import Restaurantsdta from "./Restaurantsdata";
...
const Restaurants = () => {
    ...
    const allPages = Object.entries(Restaurantsdta); // Convert object to array for iteration
  ...
  return (
      ...
      <div className='abu1'>
        ...
        <div className='des11'>
          ...
          <div className='pls1'>
            ...
            <a className='pls2 pls21' href='/cafe' id='pls2' >Cafe</a>
            <a className='pls2a pls21' href='/restaurants' id='pls3'  >Restaurants</a>
   ...
   <div className='mpls3'><a className='mpls2 ' href='/home'  id='pls1'>All Places</a>
      <a className='mpls2 mpls21' href='/cafe'  id='pls2'>Cafe</a>
      <a className='mpls2a mpls21' href='/restaurants' id='pls3'>Restaurants</a></div>
      
      <div className='mpls4'> <a className='mpls2 mpls21'  href='/stays' id='pls4'>Stay</a>
     </div>
