...
const Stays = () => {
    ...
    const allPages = Object.entries(Staysdata); // Convert object to array for iteration
    ...
    <div className='abu1'>
      ...
      <div className='des11'>
        ...
        <div className='pls1'>
          ...
          <a className='pls2a pls21' href='/stays' id='pls4'>Stay</a>
        </div>
 ...
 <div className='mpls3'><a className='mpls2 ' href='/home'  id='pls1'>All Places</a>
    ...
    <div className='mpls4'> <a className='mpls2a mpls21'  href='/stays' id='pls4'>Stay</a>
   </div>
